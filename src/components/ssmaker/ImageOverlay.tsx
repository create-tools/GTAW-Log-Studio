        ...
        {!bgImage ? (
          ...
          >
            ...
            <h3 className="text-xs font-bold text-zinc-200 mb-1">
              Oyun İçi Ekran Görüntüsü Yükleyin
            </h3>
            <p className="text-[11px] text-zinc-500 leading-relaxed mb-3">
              Görseli seçin veya doğrudan <kbd className="px-1 py-0.5 rounded bg-zinc-800 text-zinc-300 font-mono">Ctrl+V</kbd> ile yapıştırın.
            </p>
